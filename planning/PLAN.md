...
- **Database**: SQLite, single file at `db/AI Trading Workstation.db`, volume-mounted for persistence
...
│   └── .gitkeep              # Directory exists in repo; AI Trading Workstation.db is gitignored
